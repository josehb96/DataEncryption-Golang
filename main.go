...
func encrypt(key int, plainText string) (result string) {
	...
	// This function returning the equivalent letter in the encrypted text
	findOne := func(r rune) rune { // runes basically help us with unicodes. A rune represents a single unicode character. For example the value of A is 65.
